...
{
    public class FoodsCaloriesRepository : Repository<FoodsCalories> ,IFoodsCaloriesRepository
    {
        private readonly DbContext _db;

        public FoodsCaloriesRepository(DbContext dbContext) : base(dbContext)
        {
